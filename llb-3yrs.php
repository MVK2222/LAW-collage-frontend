    ...
    <title>SVD Siddhartha Law College</title>
       ...
       <style>
        ...
        .hero {
            ...
            color: #fff;
            text-align: center;
            padding: 2rem 0; /* Reduce padding to shrink height */            
            position: relative;
            overflow: hidden;
            max-height: 200px;
        }
...
<main>
    ...
    <section class="content-section">
        <div class="container_tab">
            ...
            <!-- Tab Content: About the Programme -->
            ...
            <div class="tab-content" id="eligibility">
                <div class="tab-card">
                    ...
                    <ul>
                        <li>Candidates must have passed any degree examination of Acharya Nagarjuna University/ Krishna University or a 3-year bachelor degree examination from any UGC recognized university.</li>
                        <li>A minimum of 45% aggregate marks in group subjects as well as in languages is required.</li>
                        <li>For SC & ST candidates, 40% aggregate marks in the bachelor's degree is mandatory.</li>
                        <li>Candidates must qualify in the LAWCET held annually, usually in the month of June.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="tab-content" id="objectives">
                <div class="tab-card">
                    ...
                    <ul>
                        ...
                        <li>To train students in all theoretical and practical dimensions of law.</li>
                        ...
                        <li>To develop analytical, logical, and communicative skills amongst students.</li>
                    </ul>
                </div>
            </div>
        </div>
