...
<head>
    ...
    <style>
        .hero {
            background: linear-gradient(rgba(28, 46, 74, 0.8), rgba(28, 46, 74, 0.8)), url('Images/grievances_cell.jpg');
            ...
            <div class="container">
                <div class="cell-card">
                    <div class="cell-header">
                        <i class="fas fa-hands-helping cell-icon"></i>
